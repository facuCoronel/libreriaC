...
{
    public class ImplementacionRakingProducto : IServicioRankingProductoPDF
    {
        public async Task<byte[]> ListaProductosTop(List<RankingProductosPDF> lOrden, string fechaDesde, string fechaHasta)
        {
            ...
            using (Document document = new Document(pdfDoc))
            {
                ...
                Text titulo = new Text("Ranking Productos Top").SetFontColor(ColorConstants.DARK_GRAY);
                ...
                document.Add(await new ImplementacionTablaRankingProductoTop().CrearTabla(lOrden));
